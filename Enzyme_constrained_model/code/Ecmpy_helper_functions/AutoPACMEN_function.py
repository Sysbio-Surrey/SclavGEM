...
def pickle_write(path: str, pickled_object: Any) -> None:
    ...
    * pickled_object: Any ~ The object which shall be saved in the pickle file
    ...
    try:
        ...
        print(f"pickle write problem for {path}")
        return None
...
QUERY_URL = "https://sabiork.h-its.org/sabioRestWebServices/kineticlawsExportTsv" #change to https: instead of http:
...
def sabio_rk_query_with_string(query_string: str) -> str:
    ...
    * query_string: str ~ The query string
    ...
    request = requests.post(QUERY_URL, data=query, verify=False)
